package com.wh.mybatis.core.common.util;
...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wh?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        ...
        pc.setParent("com.wh.mybatisplus");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath","com.wh.mybatisplus");
                this.setMap(map);
            }
        };
        ...
        strategy.setSuperControllerClass("cn.wh.blog.sys.controller.AbstractController");
